          ...
          <div class="container-fluid row">
            <div class="col-lg-5 border-right">
                <div class="form-group">
	                <label >Mã Tour</label>
                     <asp:TextBox runat="server" ID="txtMatour" class="form-control" readonly/>
              	</div>
        		<%--<div class="form-group">
                ...
                <div class="form-group">
	               	<label for="dstouruutien">Danh sách Tour ưu tiên</label>
                      <asp:DropDownList runat="server" class="form-control" ID="drdsuutien">
                          <asp:ListItem Selected="True" Text="Kích hoạt" />
                          <asp:ListItem Text="Vô hiệu" />
                      </asp:DropDownList>
             	</div>
                <div class="form-group">
	               	<label for="dstouruutien">Danh sách Tour Hot</label>
                      <asp:DropDownList runat="server" class="form-control" ID="drdshot">
                          <asp:ListItem Selected="True" Text="Kích hoạt" />
                          <asp:ListItem Text="Vô hiệu" />
                      </asp:DropDownList>
             	</div>
                <div class="form-group">
                    <label for="dstouruutien">Mô tả</label>
				     <asp:TextBox ID="txtMota" runat="server" TextMode="MultiLine" class="form-control h-200" placeholder=""/>
	            </div>
             	<%--<div class="form-group">
            ...
            <div class="col-md-4">
	            <div class="col-md-12">
                      ...
                      <asp:DropDownList runat="server" class="form-control" ID="drNoikhoihanh">
                          <asp:ListItem Selected="True" Text="An Giang" />
             	...
             	<div class="form-group">
		            ...
		            <asp:TextBox  runat="server" id="datepicker"  class="form-control"  />
				     <script>
              	...
              	<div class="form-group">
	           	...
	           	<div class="form-group">
		            ...
		            <asp:TextBox  runat="server" id="datepicker2"  class="form-control"  />
				    <script>
			        ...
			        <div class="form-group">
	           		...
	           		<div class="form-group">
		                <label >Ngày sửa đổi </label>
		                 <asp:TextBox  runat="server" id="datepicker3"  class="form-control"  />
				    <script>
	            ...
	            <div class="col">
		            <div class="col-12">
				        <div class="form-group">
		                 ...
		                 <asp:TextBox  runat="server" id="datepicker4"  class="form-control"  />
					    <script>
		           		...
		           		<div class="form-group">
			                <label >Ngày kết thúc</label>
			                <asp:TextBox  runat="server" id="datepicker5"  class="form-control"  />
						    <script>
                                $('#ContentPlaceHolder1_datepicker5').datepicker({
						            uiLibrary: 'bootstrap4'
						        });
						    </script>
		           		</div>
          ...
          <!-- Thêm mới tour vào danh mục -->
            <div class="col">
	            <div class="col-12">
				    ...
				    <script>
                        $('#ContentPlaceHolder1_datepicker6').datepicker({
				            uiLibrary: 'bootstrap4'
				        });
				    </script>
	           		</div>
      ...
      <!--   <div class="btn-tong" style="border: dashed 1px red;"> -->
            <div class="row">
                    <div class="ml-20" style="margin-left:321px;">
                              <asp:Button ID="btn_Them" class="btn-lg btn-primary mt-3 mr-4 btn-form" runat="server" OnClick="btn_Them_Click" Text="Thêm" />
                              <asp:Button ID="btn_Capnhat" class="btn-lg btn-warning mt-3 mr-4 btn-form" runat="server" Text="Cập Nhật" />
                              <asp:Button ID="btn_Xoa" class="btn-lg btn-danger mt-3 mr-4 btn-form" runat="server" Text="Xóa" />
                     </div>
            </div>
	    <!-- </div> -->
	       <!-- Bảng danh sách tour -->
                     <div class="content3" style="border: dashed 1px black;">
                          ...
                          <asp:Repeater runat="server" ID="rpDSTour">
                          <HeaderTemplate>
	                        <table class="table table-striped table-bordered table-hover text-center">
	                          <thead class="thead-dark">
	                            <tr>
